...
contract LimitedEditionNFTTest is Test {
    ...
    function testConstructor() public {
        LimitedEditionNFT nftTest = new LimitedEditionNFT(BASE_PRICE, DISCOUNT_PRICE, merkleRoot);
        assertEq(nftTest.basePrice(), BASE_PRICE, "Base price should be 9999 gwei");
        assertEq(nftTest.discountPrice(), DISCOUNT_PRICE, "Discount price should be 7777 gwei");
        assertEq(nftTest.merkleRoot(), merkleRoot, "Merkle root should be the same");
    }
